...
<section class="section details">
    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                            <div class="card__content">
                                ...
                                <ul class="card__meta">
                                    ...
                                    <li><span>Running time:</span> {{ $movie->running_time }} h</li>
                                    <li><span>Type:</span> <a href="#">MOVIE</a> </li>
                                </ul>
            ...
            <!-- player -->
            <div class="col-12 col-xl-6">
                <iframe id="player" width="560" height="315" src="{{ $movie->vimeo_url }}" frameborder="0"
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="1-tab">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    @comments(['model' => $movie,'approved' => true])
                                </div>
                            </div>
                            <!-- end comments -->
                        </div>
